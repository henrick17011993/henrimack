    ...
    <main>
        ...
        <hr>
                <fieldset>
                    ...
                    <form>
                        <select <?=$dadosTabela["TIPO"]?> <?= $_GET["acao"] &&  $_GET["acao"] == "r"?"readonly":"";?> name="Tipo" id="Tipo">>
                        ...
                        <div class="div-input" id="divNome">
                            ...
                            <input type="text"value="<?=$dadosTabela["MODELOS"]?>" <?= $_GET["acao"] &&  $_GET["acao"] == "r"?"readonly":"";?> name="Modelos" id="Modelos">
                        </div>
                        
                        <div class="div-input" id="divNome">
                            <label for="Cor">Cor</label>
                            <input type="text"value="<?=$dadosTabela["COR"]?>" <?= $_GET["acao"] &&  $_GET["acao"] == "r"?"readonly":"";?> name="Cor" id="Cor">
                        </div>
                        <div class="div-input" id="divNome">
                            <label for="Valor">Valor</label>
                            <input type="number"value="<?=$dadosTabela["VALOR"]?>" <?= $_GET["acao"] &&  $_GET["acao"] == "r"?"readonly":"";?> name="Valor" id="Valor">
                        </div>
                    </fieldset>
